...
p <- SCpubr::do_FeaturePlot(sample,
 ...
 # Figure S1F ---------                           
markers <- list("ATRT-TYR" = c("TYR", "MITF", "OTX2"),
                "ATRT-SHH" = c("HES1", "GLI2", "BOC"),
                "ATRT-MYC" = c("MYC", "CEBPB", "HOTAIR"))
...
p1 <- SCpubr::do_EnrichmentHeatmap(sample, 
                                   ...
                                   font.size = 16, 
                                   flavor = "UCell", 
                                   features.order = c("ATRT-TYR", "ATRT-SHH", "ATRT-MYC"),
                                   groups.order = list("subtype" = c("ATRT-MYC", "ATRT-SHH", "ATRT-TYR")),
                                   legend.position = "bottom",
...
p2 <- SCpubr::do_ExpressionHeatmap(sample, 
                                   features = markers, 
                                   group.by = "subtype", 
                                   flip = FALSE, 
                                   font.size = 16, 
                                   features.order = unlist(unname(markers)), 
                                   legend.position = "bottom",
                                   legend.length = 10,
                                   number.breaks = 5,
                                   groups.order = list("subtype" = c("ATRT-MYC", "ATRT-SHH", "ATRT-TYR"))) + 
